...
$CALENDARBOOTSTRAP3_TEMPLATE['event']['eventlist_table_start'] = "<br /><table class='table fborder'>{EC_EVENTARCHIVE_CAPTION}";
...
$CALENDARBOOTSTRAP3_TEMPLATE['next_event_menu']['cal_fe_line'] = "{EC_NEXT_EVENT_RECENT_ICON}{EC_NEXT_EVENT_ICON}{EC_NEXT_EVENT_DATE}{EC_NEXT_EVENT_TIME}<br /><strong>{EC_NEXT_EVENT_TITLE}</strong>{EC_NEXT_EVENT_GAP}";
